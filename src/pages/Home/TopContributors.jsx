        ...
        <section className="py-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-medium text-center my-10 lg:my-20">Top Contributors</h2>
                    <span className="text-sm text-gray-400">Last Updated: February 2024</span>
                </div>
